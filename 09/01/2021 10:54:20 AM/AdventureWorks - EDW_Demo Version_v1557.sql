...
-- ************************************** "EDW"."ChildTest"
CREATE TABLE "EDW"."ChildTest"
(
 "ChildTestId"   NOT NULL,
 "TestRoleName" number(38,0) NOT NULL COMMENT 'Scenario Identifier',
 "CreatedBy"    varchar(50) NOT NULL,
 "CreatedDate"  timestamp_ntz(9) NOT NULL,
 "UpdatedDate"  timestamp_ntz(9) NOT NULL,
 "UpdatedBy"    varchar(50) NOT NULL,
 CONSTRAINT "PK_621" PRIMARY KEY ( "ChildTestId" ),
 CONSTRAINT "FK_616" FOREIGN KEY ( "TestRoleName" ) REFERENCES "EDW"."DimScenario" ( "ScenarioKey" )
);
